...
#define GM_GC_DEFAULT_WORK_INCREMENT 100          // Desired number of objects to trace per frame
#define GM_GC_DEFAULT_DESTRUCT_INCREMENT 100      // Desired number of old objects to free per frame
