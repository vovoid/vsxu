...
struct gmVariable
{
  ...
  inline int GetIntSafe();
  /// Return float/int or zero
  inline float GetFloatSafe();
  /// Return string object or null
  inline gmStringObject* GetStringObjectSafe();
  /// Return table object or null
  inline gmTableObject* GetTableObjectSafe();
  /// Return function object or null
  inline gmFunctionObject* GetFunctionObjectSafe();
  /// Return c string or empty string
  const char* GetCStringSafe();
  /// Return user type ptr or null
  void* GetUserSafe(int a_userType);
...
gmStringObject * gmVariable::GetStringObjectSafe()
{
  if( GM_STRING == m_type )
  {
...
inline gmTableObject * gmVariable::GetTableObjectSafe()
{
  if( GM_TABLE == m_type )
  {
...
inline gmFunctionObject * gmVariable::GetFunctionObjectSafe()
{
