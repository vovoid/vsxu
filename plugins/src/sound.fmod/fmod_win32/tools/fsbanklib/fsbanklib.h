...
#define FSBANK_BUILD_DONTINTERLEAVE             0x00000100 /* For stereo and above sounds, dont interleave the data as LRLRLRLR.. instead use LLLLRRRR type encoding.  PS2 VAG, PSP VAG, GCADPCM only. */
