...
Public Const FMOD_VERSION As Long = &H41305
...
Public Enum FMOD_INITFLAGS
    ...
    FMOD_INIT_ENABLE_DSPNET = &H20                   ' All platforms - Enable TCP/IP based host which allows "DSPNet Listener.exe" to connect to it, and view the DSP dataflow network graph in real-time. */
...
'[REMARKS]
'If you haven't called Channel::setDelay yet, if you call Channel::getDelay with FMOD_DELAYTYPE_DSPCLOCK_PCM it will return the
...
Public Enum FMOD_DELAYTYPE
    ...
    FMOD_DELAYTYPE_DSPCLOCK_PCM        ' Time the sound started if Channel::getDelay is used, or if Channel::setDelay is used, the sound will delay playing until this exact tick. */
