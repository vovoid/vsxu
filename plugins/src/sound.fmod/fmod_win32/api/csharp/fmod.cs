...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00041305;
    ...
    */
    public enum DELAYTYPE
    {
        ...
        DSPCLOCK_PCM,        /* Time the sound started if Channel::getDelay is used, or if Channel::setDelay is used, the sound will delay playing until this exact tick. */
