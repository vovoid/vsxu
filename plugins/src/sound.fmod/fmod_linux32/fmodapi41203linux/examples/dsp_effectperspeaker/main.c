...
//const FMOD_MODE FMOD_NORMAL2 = (FMOD_HARDWARE | FMOD_LOOP_OFF | FMOD_2D);  /* FMOD_NORMAL is a default sound type.  Loop off, hardware accelerated, and 2D. */
...
int main(int argc, char *argv[])
{
    ...
    float            pan = 0;
    const FMOD_MODE FMOD_NORMAL3 = (FMOD_HARDWARE | FMOD_LOOP_OFF | FMOD_2D);  /* FMOD_NORMAL is a default sound type.  Loop off, hardware accelerated, and 2D. */
